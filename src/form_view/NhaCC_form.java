 ...
 */
public class NhaCC_form extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NhaCC_form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
