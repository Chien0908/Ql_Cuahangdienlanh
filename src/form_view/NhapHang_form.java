 ...
 */
public class NhapHang_form extends javax.swing.JFrame {
    ...
    /**
     * Creates new form NhapHang_form
     */
    ...
    public void bangnhanvien(){
        tblTitlenv.add("Mã nhân viên"); tblTitlenv.add("Họ tên nhân viên"); tblTitlenv.add("Số đt"); tblTitlenv.add("Tài khoản"); tblTitlenv.add("Mật khẩu"); tblTitlenv.add("Chức vụ"); 
    }
    ...
    public void laydulieuphieunhap(ArrayList<HoaDonNhap> dshdn){
        ...
        for(HoaDonNhap b : dshdn){
            Vector v = new Vector();
            v.add(b.getMancc()); v.add(b.getMahdn()); v.add(b.getNgaynhap());v.add(b.getMancc());v.add(b.getManv());v.add(b.getTongtien());
    ...
    public void laydulieusanpham(ArrayList<SanPham> dssp){
        ...
        table_sanpham.setModel(new DefaultTableModel(tblDatactnhaphang, tblTitlesanpham));
    }
    //===================================================================================================================================================================================
    ...
    private void table_hdnhapMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_hdnhapMouseClicked
        ...
        for(NhanVien b : dsttctnv){
            ...
            tenncc_txt1.setText( b.getHoten());
        }
    ...
    //===================================================================================================================================================================================
     public Boolean KiemTraTXTHoaDonNhap(){
        if(hdn_txt.getText().equals("")|| ngaynhap_txt.getText().equals("")|| mncc_txt.getText().equals("")|| mnv_txt.getText().equals("") ||tongtien_txt.getText().equals("")){
        ...
        // TODO add your handling code here:
          if(KiemTraTXTHoaDonNhap()  ){
            if(JOptionPane.showConfirmDialog(this, "Bạn có chắc muốn thêm không?", "Thông báo", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
                String sql = "insert into hoadonnhap( ngaynhap, mancc,manv,tongtien) values ( N'"+ngaynhap_txt.getText().trim()+"', N'"+mncc_txt.getText().trim()+"', N'"+mnv_txt.getText().trim()+"', N'"+tongtien_txt.getText().trim()+"')";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(KiemTraTXTHoaDonNhap()){
            if(JOptionPane.showConfirmDialog(this, "Bạn có chắc muốn sửa không?", "Thông báo", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
                 String sql = "update HOADONNHAP set  ngaynhap= N'"+ngaynhap_txt.getText().trim()+"', mancc=N'"+mncc_txt.getText().trim()+"', manv='"
                +mnv_txt.getText().trim()+"', sdt='"+tongtien_txt.getText().trim()+"'  where mahdn='"+hdn_txt.getText().trim()+"'";
    ...
    public Boolean KiemTraTXTCTHoaDonNhap(){
        if( msp2_txt.getText().equals("")|| soluong_txt.getText().equals("")|| gianhap_txt.getText().equals("") ||thanhtien_txt.getText().equals("")){
            JOptionPane.showMessageDialog(this, "Vui lòng nhập đầy đủ thông tin", "Thông báo", 2);
            return false;
        }
        return true;
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
         if(KiemTraTXTCTHoaDonNhap()&&KiemTraTinhTien()){
            if(JOptionPane.showConfirmDialog(this, "Bạn có chắc muốn sửa không?", "Thông báo", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
                String sql = "update ChiTietHoaDonNhap set masp = N'"+msp2_txt.getText().trim()+"',soluongnhap = N'"+soluong_txt.getText().trim()+"',dongianhap = N'"+gianhap_txt.getText().trim()+"',thanhtien = N'"+thanhtien_txt.getText().trim()+"' where macthdn = N'"+mcthd_txt.getText().trim()+"'";
                dscthdn = NhapHangDAO.getDSCTHDN();
                laydulieuctnhaphang(dscthdn);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NhapHang_form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NhapHang_form().setVisible(true);
            }
        });
    }
